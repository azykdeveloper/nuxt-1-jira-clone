<template>
  ...
  >
    <h2 class="text-3xl font-bold">Produced</h2>

    <LayoutsDocCreateDeal :status="EnumStatus.produced" :refetch="refetch" />
  </div>
...
useHead({ title: "Produced | Jira" });

const { data, isLoading, refetch } = useDealsQuery(EnumStatus.produced);
